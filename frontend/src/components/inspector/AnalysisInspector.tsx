      ...
      >
        ...
        <Section title="Overview">
          ...
          <Row
            label="Scenario"
            value={
              analysis.simulation.scenario || "Not Executed"
            }
          />
        </Section>
                <div
      ...
      {selectedLayerId === "criticality" && (
        <>
          ...
          <Section title="Resilience">
            <Row
              label="Components"
              value={analysis.resilience.connected_components}
            />

            <Row
              label="Largest Component"
              value={analysis.resilience.largest_component}
            />
          </Section>
          ...
          <Section title="Simulation">
            ...
            <Row
              label="Removed Nodes"
              value={analysis.simulation.removed_nodes.length}
            />

            <Row
              label="Remaining Nodes"
              value={analysis.simulation.remaining_nodes}
            />

            <Row
              label="Remaining Edges"
              value={analysis.simulation.remaining_edges}
            />

            <Row
              label="Components"
              value={analysis.simulation.connected_components}
            />

            <Row
              label="Largest Component"
              value={analysis.simulation.largest_component}
            />
          </Section>
